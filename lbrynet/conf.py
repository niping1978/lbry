...
class Config(CLIConfig):
    ...
    # protocol timeouts
    download_timeout = Float("Cumulative timeout for a stream to begin downloading before giving up", 90.0)
    blob_download_timeout = Float("Timeout to download a blob from a peer", 60.0)
